# -*- encoding: utf-8 -*-
# stub: logstash-filter-grok 4.4.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-patterns-core>.freeze, [">= 4.3.0", "< 5"])
      ...
      s.add_dependency(%q<logstash-patterns-core>.freeze, [">= 4.3.0", "< 5"])
