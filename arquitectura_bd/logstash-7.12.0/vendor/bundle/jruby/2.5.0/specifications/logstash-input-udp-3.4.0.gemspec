# -*- encoding: utf-8 -*-
# stub: logstash-input-udp 3.4.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-mixin-ecs_compatibility_support>.freeze, ["~> 1.1"])
      ...
      s.add_dependency(%q<logstash-mixin-ecs_compatibility_support>.freeze, ["~> 1.1"])
