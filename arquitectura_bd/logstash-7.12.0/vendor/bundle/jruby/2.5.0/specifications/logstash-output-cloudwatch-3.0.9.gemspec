# -*- encoding: utf-8 -*-
# stub: logstash-output-cloudwatch 3.0.9 ruby lib

Gem::Specification.new do |s|
  s.name = "logstash-output-cloudwatch".freeze
  s.version = "3.0.9"
  ...
  s.summary = "Aggregates and sends metric data to AWS CloudWatch".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-mixin-aws>.freeze, [">= 1.0.0"])
      ...
      s.add_dependency(%q<logstash-mixin-aws>.freeze, [">= 1.0.0"])
